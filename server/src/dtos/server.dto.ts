...
const ServerStatsResponseSchema = z
  .object({
    photos: z.int().default(0).describe('Total number of photos'),
    videos: z.int().default(0).describe('Total number of videos'),
    usage: z.int().default(0).describe('Total storage usage in bytes'),
    usagePhotos: z.int().default(0).describe('Storage usage for photos in bytes'),
    usageVideos: z.int().default(0).describe('Storage usage for videos in bytes'),
    usageByUser: z.array(UsageByUserSchema).default([]).describe('Array of usage for each user'),
  })
